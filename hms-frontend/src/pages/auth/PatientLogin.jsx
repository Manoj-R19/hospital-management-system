        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center border border-blue-100">
              <HeartPulse className="w-6 h-6 text-blue-650" />
            </div>
          </div>
          <h2 className="text-2xl font-display font-extrabold text-slate-900 tracking-tight">Patient Login</h2>
          <p className="text-slate-500 text-xs mt-1">Access your personal health records</p>
        </div>
